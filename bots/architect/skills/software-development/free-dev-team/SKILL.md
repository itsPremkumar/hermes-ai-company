...
terminal(background=true, command='cd "/c/Users/PREM KUMAR/samm" && env -u PYTHONPATH /c/Users/PREM\ KUMAR/AppData/Local/Programs/Python/Python312/python.exe -m pytest tests/ -q -p no:cacheprovider --tb=line > /tmp/samm.log 2>&1; echo "EXIT=$?" >> /tmp/samm.log')

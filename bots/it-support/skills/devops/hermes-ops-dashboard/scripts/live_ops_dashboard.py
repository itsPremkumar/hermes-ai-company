...
Hermes Live Ops Dashboard -- reads REAL data every request.
  ...
  * Scheduled agents  -> C:\Users\PREM KUMAR\AppData\Local\hermes\cron\jobs.json
  * Live OS processes -> Windows tasklist.exe / wmic.exe (real-time)
  * Live sub-agent progress -> C:\Users\PREM KUMAR\AppData\Local\hermes\state.db
...
CRON_DB = r"C:\Users\PREM KUMAR\AppData\Local\hermes\cron\jobs.json"
REPO_ROOTS = [r"C:\one", r"C:\Users\PREM KUMAR\prems-jarvis-hermes"]
PORT = 8765

...
- `default`
- `second-account-agent` — Dedicated Hermes profile for the the second GitHub account — isolated sessions, memory, and gateway login for second-account work (repos under github-acc2 SSH alias).
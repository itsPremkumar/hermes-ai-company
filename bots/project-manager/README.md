...
| File | Purpose |
|---|---|
| `SOUL.md` | persona + standing orders (deploy to `profiles/project-manager/SOUL.md`) |
...
```bash
# create
hermes profile create project-manager --no-skills --description "<see docs/02>"
# deploy identity + config from this folder
cp SOUL.md %HERMES_HOME%/profiles/project-manager/SOUL.md
cp config.yaml %HERMES_HOME%/profiles/project-manager/config.yaml
cp %HERMES_HOME%/.env %HERMES_HOME%/profiles/project-manager/.env   # REQUIRED: keys
# use
